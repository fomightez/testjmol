...
Clazz.load (["JU.M3"], "JU.M4", ["JU.T3"], function () {
...
function (row, col, v) {
if (row < 3 && col < 3) {
Clazz.superCall (this, JU.M4, "setElement", [row, col, v]);
return;
...
$_M(c$, "getElement", 
function (row, col) {
if (row < 3 && col < 3) return Clazz.superCall (this, JU.M4, "getElement", [row, col]);
switch (row) {
case 0:
return this.m03;
case 1:
...
$_M(c$, "setRowA", 
function (row, v) {
if (row < 3) Clazz.superCall (this, JU.M4, "setRowA", [row, v]);
switch (row) {
case 0:
this.m03 = v[3];
return;
...
$_M(c$, "getRow", 
function (row, v) {
if (row < 3) Clazz.superCall (this, JU.M4, "getRow", [row, v]);
switch (row) {
case 0:
v[3] = this.m03;
return;
...
$_M(c$, "getColumn", 
function (column, v) {
if (column < 3) Clazz.superCall (this, JU.M4, "getColumn", [column, v]);
switch (column) {
case 0:
v[3] = this.m30;
return;
...
$_M(c$, "sub", 
function (m1) {
Clazz.superCall (this, JU.M4, "sub", [m1]);
this.m03 -= m1.m03;
this.m13 -= m1.m13;
this.m23 -= m1.m23;
this.m30 -= m1.m30;
...
$_M(c$, "transpose", 
function () {
Clazz.superCall (this, JU.M4, "transpose", []);
var tmp = this.m03;
this.m03 = this.m30;
this.m30 = tmp;
tmp = this.m13;
...
$_M(c$, "setM3", 
function (m1) {
Clazz.superCall (this, JU.M4, "setM3", [m1]);
this.m03 = this.m13 = this.m23 = this.m30 = this.m31 = this.m32 = 0.0;
this.m33 = 1.0;
}, "JU.M3");
$_V(c$, "setA", 
...
}, $fz.isPrivate = true, $fz), "JU.T4,JU.T4");
$_M(c$, "set", 
