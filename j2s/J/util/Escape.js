...
Clazz.load (null, "J.util.Escape", ["java.lang.Character", "$.Float", "java.util.Map", "JU.A4", "$.BS", "$.List", "$.M3", "$.M4", "$.P3", "$.P4", "$.PT", "$.SB", "$.T3", "J.script.SV", "J.util.BSUtil", "$.Quaternion"], function () {
...
if (Clazz.instanceOf (x, JU.M3)) return JU.PT.rep ((x).toString (), "\t", ",\t");
